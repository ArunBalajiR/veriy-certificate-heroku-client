...
downloadPDF = () => {
  ...
  doc.html(document.querySelector("#dpdf"), {
      ...
      if(this.state.newcert) 
      {
        return (
          <div className='min-h-full bg-gray-100 text-gray-900 md:flex justify-center'>
            <ToastContainer />
            <div className='max-w-screen-xl m-0 sm:m-5 bg-white shadow sm:rounded-lg flex flex-col flex-1' id="dpdf">
                ...
                <h1 className='pt-20 text-2xl xl:text-3xl font-extrabold text-center'>
                  ...
                  >  
                    ...
                    <button
                        className='mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none'
                      >
                      <a href={this.state.blockurl} target="_blank" rel="noopener noreferrer">View Block</a>
                      </button>
                    </div>
